"""Migrate Airbyte pull_requests stream state from old flat format to new nested format."""
...
TARGET_DEFINITION_NAME = "Span Jira - declarative i"
...
def main():
    ...
    parser.add_argument("--db-password", default="docker")
    ...
    try:
        with conn.cursor() as cur:
            ...
            if not row:
                print(f"No pull_requests state found for connection {args.connection_id}")
                sys.exit(1)
